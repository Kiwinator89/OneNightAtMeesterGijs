...
const NIGHT_CONFIGS = {
  ...
  3: {
    ...
    lore:'Jeffrey slaapt niet. Hij loopt. En hij stopt nooit. Maduro duikt vaker op dan je lief is.',
    quote:'"The doors will not save you from everything."',
    warn:'⚠ Jeffrey negeert deuren — gebruik lure. ⚠ Maduro: kijk niet te lang op één camera. ⚠ ALARM knop beschikbaar.',
    gijsActive:true, hoboActive:true, tomActive:true, markRutteActive:true,
    jeffreyActive:true, chapoActive:false, diddyActive:false,
    maduroChance:0.04, shadowChance:0.005,
    moveIval:[24000,17000,12000,8500,5500,3500],
    hoboMinMs:4500, hoboMaxMs:16000,
  },
  4: {
    label:'Nacht 4 · De Linker Gang',
    lore:'Chapo is er nu ook. Hij negeert deuren volledig — alleen het alarm of de lure werkt. Alles wordt sneller.',
    quote:'"You cannot close the door on everything."',
    warn:'⚠ Chapo is immuun voor deuren — gebruik ALARM of lure. ⚠ Jeffrey loopt sneller. ⚠ Alarm CD: 20s.',
    gijsActive:true, hoboActive:true, tomActive:true, markRutteActive:true,
  ...
  5: {
    ...
    lore:'Diddy is er nu ook. Hij negeert deuren volledig. Alle vijanden. Gebruik alles wat je hebt. <strong>Veel succes.</strong>',
    quote:'"I told you to study. You didn\'t listen."',
    warn:'⚠ Diddy negeert deuren — ALARM of lure. ⚠ ALLE vijanden actief. ⚠ Niet alles is wat het lijkt.',
    gijsActive:true, hoboActive:true, tomActive:true, markRutteActive:true,
